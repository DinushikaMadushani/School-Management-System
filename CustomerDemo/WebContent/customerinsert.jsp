...
<div class="navbar">
	...
	<div class="about-area" id="about">
		<div class="text-part">
	<form class="text" action="insert" method="post">
		<input type="text" placeholder="Your Name" name="name" required><br>
		<input type="text" placeholder="Your Email" name="email" required><br>
		<input type="text" placeholder="Your Phone Number" name="phone" required><br>
		<input type="text" placeholder=" NIC Number" name="NIC" required><br>
