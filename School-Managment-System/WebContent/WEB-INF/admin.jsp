...
<div class="w3-bar-block">
 ...
 <a class="w3-bar-item w3-button" href="/js/js_htmldom.asp">Learn HTML-DOM</a>
 ...
 <div class="w3-container">
 <h4 class="w3-margin-top">Artificial Intelligence</h4>
 </div>
 ...
 <a class="w3-bar-item w3-button" href="/mysql/sql_ref_functions.asp">MySQL Reference</a> 
 ...
 <a class="w3-bar-item w3-button" href="/git/exercise.asp?filename=exercise_getstarted1">Git Exercises</a>
</div>
</nav>
